...
conky.config = {
    ...
    template6="65b5411361da23f0a22127657915a6e2",
...
${font Roboto:size=14}${execi 300 LANG=${template9} LC_TIME=${template9} date +"%d"}${font}${color}
#
# [ CITY ]
#
${voffset 2}${alignr}${font Roboto:size=14}${color0}${execi 300 jq -r .name ${template4}/weather.json | sed "s|\<.|\U&|g"}${font}${color}
#
# [ WEATHER DESCRIPTION ]
#
...
#
${execi 300 cp -f ${template3}/.icons/#fff__32/$(${template3}/parse_weather 'first' '.weather[0].id' '1').png ${template4}/weather-1.png}${image ${template4}/weather-1.png -p 25,140 -s 32x32}\
${execi 300 cp -f ${template3}/.icons/#fff__32/$(${template3}/parse_weather 'first' '.weather[0].id' '2').png ${template4}/weather-2.png}${image ${template4}/weather-2.png -p 83,140 -s 32x32}\
${execi 300 cp -f ${template3}/.icons/#fff__32/$(${template3}/parse_weather 'first' '.weather[0].id' '3').png ${template4}/weather-3.png}${image ${template4}/weather-3.png -p 145,140 -s 32x32}
${execi 300 cp -f ${template3}/.icons/#fff__32/$(${template3}/parse_weather 'first' '.weather[0].id' '4').png ${template4}/weather-4.png}${image ${template4}/weather-4.png -p 205,140 -s 32x32}
${execi 300 cp -f ${template3}/.icons/#fff__32/$(${template3}/parse_weather 'first' '.weather[0].id' '5').png ${template4}/weather-5.png}${image ${template4}/weather-5.png -p 265,140 -s 32x32}
#
...
${alignr}Packages: ${color0}${execi 360 apt list --upgradable "~U" | wc -l | tail} update(s)${color} ${color1}|${color} Sys temp: ${color9}${hwmon temp 1}°C${color}
#
# [ SEPARATOR ]
#
${voffset -2}${color1}${hr}${color}
...
${alignr}Core0 temp: ${color9}${execi 10 sensors | grep 'Core 0' | cut -c17-24} ${color1}|${color} Core1 temp: ${color9}${execi 10 sensors | grep 'Core 1' | cut -c17-24}${color}
${voffset -77}${alignr 190}${voffset 2}${cpugraph 54,130 ${template2}}
#
# [ SEPARATOR ]
#
...
${alignr}NASka: ${color0}${fs_used_perc /media/admin}% (${fs_used /media/admin}${color} / ${color0}${fs_size /media/admin})${color}
#${alignr}${color9}R: ${color0}${diskio_read /dev/sda2} ${color1}|${color} ${color3}W: ${color0}${diskio_write /dev/sda2}${color}
#${voffset -32}${alignr 150}${diskiograph /media/admin 25,170 ${template2}}
#
# [ SEPARATOR ]
#
...
# [ CONNECTIONS ]
#
${alignr}Up: ${color0}${upspeed wlp3s0}${color}
${alignr}Sent: ${color0}${totalup wlp3s0}${color}
${voffset -31}${alignr 100}${upspeedgraph wlp3s0 24,220 ${template2}}
${alignr}Down: ${color0}${downspeed wlp3s0}${color}
${alignr}Received: ${color0}${totaldown wlp3s0}${color}
${voffset -33}${alignr 100}${downspeedgraph wlp3s0 24,220 ${template2}}
...
${alignr}Local IP: ${color0}${addr wlp3s0} ${color1}|${color} Public IP: ${color0}${execi 60 wget -O - -q icanhazip.com}${color}
${else}\
...
${alignr}Local IP: ${color0}${addr wlp3s0} ${color1}|${color} Public IP: ${color0}${execi 60 wget -O - -q icanhazip.com}${color}
#${alignr}Mac addr: ${color0}${wireless_ap wlp3s0}
${else}\
